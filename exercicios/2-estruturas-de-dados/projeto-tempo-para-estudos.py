...
total_horas = input('Qual é a média de horas estudada por dia?')

# 4. Crie uma variável chamada "curso" e, usando o método input(), solicite o título do curso desejado;
curso = input('Qual o curso que esta estudando atualmente?')
...
print(f'Olá {nome}, você costuma estudar {total_dias} dias por semana, durante mais ou menos {total_horas}hrs diárias. Isso significa que você estuda em média {total_dias*total_horas} horas por semana para o curso {curso}.')